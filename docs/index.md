...
After the site is published, a good smoke test is:

1. open the GitHub Pages site and verify the one-page navigation;
2. follow either Path A or Path B with test credentials;
3. confirm `GET /health` and `GET /events` before starting detailed Home Assistant troubleshooting.
