...
public class HealthController {
    ...
    public HealthResponse health() {
        ...
        return new HealthResponse(
                ...
                rocketMqHealth.getLastRawMessageAt(),
                rocketMqHealth.getLastParsedMessageAt(),
                rocketMqHealth.getLastPublishedEventAt(),
                rocketMqHealth.getRawMessageCount(),
                rocketMqHealth.getParsedMessageCount(),
                rocketMqHealth.getPublishedEventCount(),
                rocketMqHealth.getIgnoredMessageCount(),
                rocketMqHealth.getProcessingErrorCount(),
                rocketMqHealth.getLastMessageType(),
                rocketMqHealth.getLastIgnoredReason(),
